...
class DataFrameWrapper:
    ...
    def sel_masks(self, criterias, *, how='all', invert=False):
        """
        ...
        return self.sel_mask(mask, invert=invert)
    ...
    def sel_match(self, *, how='all', invert=False, **col_values):
        ...
        return self.sel_masks(criterias, how=how, invert=invert)
    ...
    def sel_between(self, *, invert=False, how='all', **col_ranges):
        ...
        """
        criterias = [
            self.reg[col].between(*value_range)
            for col, value_range in col_ranges.items()
        ]

        return self.sel_masks(criterias, how=how, invert=invert)

    def sel_isin(self, *, invert=False, how='all', **col_values):
        """
